 ...
 */
public class YhSpinner extends TextView {

  private OnNothingSelectedListener onNothingSelectedListener;
  private OnItemSelectedListener onItemSelectedListener;
  private YhSpinnerBaseAdapter adapter;
  ...
  private int backgroundParentSelector;
  ...
  public YhSpinner(Context context) {
    super(context);
    init(context, null);
  }

  public YhSpinner(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs);
  }

  public YhSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    init(context, attrs);
  }

  private void init(Context context, AttributeSet attrs) {
    TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.YhSpinner);
...
//    setBackgroundResource(R.drawable.ms__selector);
    ...
    if(backgroundParentSelector!=0){
      listView.setBackgroundResource(backgroundParentSelector);
    }
    ...
    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      @Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (onItemSelectedListener != null) {
          ...
          onItemSelectedListener.onItemSelected(YhSpinner.this, position, id, item);
        }
      }
    });
...
//    }
    ...
    popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
      ...
      @Override public void onDismiss() {
        if (nothingSelected && onNothingSelectedListener != null) {
          onNothingSelectedListener.onNothingSelected(YhSpinner.this);
        }
        if (!hideArrow) {
          animateArrow(false);
        }
    ...
    //设置默认选项
    if(entries!=0) {
      String[] entriesString = getResources().getStringArray(entries);
      if (entriesString.length > 0) {
        setItems(Arrays.asList(entriesString));
      }
    }
  }
  ...
  public <T> void setItems(@NonNull List<T> items) {
    adapter = new YhSpinnerAdapter<>(getContext(), items)
  ...
  public YhSpinnerBaseAdapter getAdapter(){
    return adapter;
  }
  ...
  public void setAdapter(@NonNull ListAdapter adapter) {
    this.adapter = new YhSpinnerAdapterWrapper(getContext(), adapter)
        .setPopupPadding(popupPaddingLeft, popupPaddingTop, popupPaddingRight, popupPaddingBottom)
        .setBackgroundSelector(backgroundSelector)
        .setTextColor(textColor);
   ...
   * @param <T> The type
   */
  public <T> void setAdapter(YhSpinnerAdapter<T> adapter) {
  ...
  private void setAdapterInternal(@NonNull YhSpinnerBaseAdapter adapter) {
  ...
  public interface OnItemSelectedListener<T> {
     ...
     * item.</p>
     *
     * @param view The {@link YhSpinner} view
     * @param position The position of the view in the adapter
     * @param id The row id of the item that is selected
     * @param item The selected item
     */
    void onItemSelected(YhSpinner view, int position, long id, T item);
  }
  ...
  public interface OnNothingSelectedListener {
     ...
     *
     * @param spinner the {@link YhSpinner}
     */
    void onNothingSelected(YhSpinner spinner);
  }
}