...
public abstract class YhSpinnerBaseAdapter<T> extends BaseAdapter {
  ...
  public YhSpinnerBaseAdapter(Context context) {
...
//      }
  ...
  public YhSpinnerBaseAdapter<T> setTextColor(@ColorInt int textColor) {
    this.textColor = textColor;
    return this;
  }

  public YhSpinnerBaseAdapter<T> setBackgroundSelector(@DrawableRes int backgroundSelector) {
    this.backgroundSelector = backgroundSelector;
    return this;
  }

  public YhSpinnerBaseAdapter<T> setPopupPadding(int left, int top, int right, int bottom) {
